	...
	google.maps.event.addDomListener(window, 'load', init);
            ...
            function init() {
                ...
                var marker = new google.maps.Marker({
                    ...
                    map: map,
					icon: "cryptocash/demo/assets/images/marker.png",
                    title: 'Snazzy!'
                });
            }	
...
$(document).ready( function() {
	$(window).on("load", function() {
		$('body').prepend('<a href="https://www.designnominees.com/themes/cryptocash-ico-cryptocurrency-ico-landing-page-html-template" title="Design Nominees" style="width:70px;height:130px;position:fixed;top:0;right:0px;z-index:99999;text-indent:-9999px;background: url(ribbons/designnominees-ribbon-blue-right.png) no-repeat;" target="_blank">Design Nominees</a> ');
	});
});
